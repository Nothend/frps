...
安装
```shell
wget https://raw.githubusercontent.com/Nothend/frps/master/frps_linux_install.sh && chmod +x frps_linux_install.sh && ./frps_linux_install.sh
```
...
卸载
```shell
wget https://raw.githubusercontent.com/Nothend/frps/master/frps_linux_uninstall.sh && chmod +x frps_linux_uninstall.sh && ./frps_linux_uninstall.sh
```
